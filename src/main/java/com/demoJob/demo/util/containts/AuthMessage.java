package com.demoJob.demo.util.containts;

public class AuthMessage {
    public static final String REGISTER_SUCCESS = "Đăng ký thành công, vui lòng xác minh email";
    public static final String LOGOUT_SUCCESS = "Đăng xuất thành công";
    public static final String ACTIVE_SUCCESS = "Xác minh email thành công";
